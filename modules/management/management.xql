...
let $base-url := string($cmd/@base-url)
    ...
    <Page
        ...
        <Content>
            <Tabs>
                ...
                <Tab
                    Id="contractors">
                     <Controller>management/externalservice</Controller>
                    <Name>External service providers</Name>
                </Tab>
            </Tabs>
            <Modals>
                <Modal
                ...
                <Modal
                    Id="c-contractors-editor"
                    Width="800"
                    data-backdrop="static"
                    data-keyboard="false">
                    <Name>External service providers</Name>
                    <Template>templates/contractors?goal=update</Template>
                    <Commands>
                        <Save
                            data-replace-type="event"/>
                        <Cancel/>
