...
return
  <Display  Mode="workflow">
      <TabGroups>
        
        <Group>
          <Name loc="workflow.group.ocr">Ocr</Name>
           
            <Tab Id="annexes">
              <Name loc="workflow.tab.annexes">Annexes</Name>
              {
              if (access:check-entity-permissions('create', 'Annex', <Case/>, <Activity/>)) then 
                <Drawer Command="annex" loc="action.add.annex" AppenderId="c-annex-list">
                  <Title loc="workflow.title.annexes">Documents annexes</Title>
                  <Controller>docs</Controller>
                  <Template>exist/projects/diae/ocr/templates/annex</Template>
                </Drawer>
              else
                <Heading>
                  <Title loc="workflow.title.annexes">Documents annexes</Title>
                </Heading>,
              local:gen-annexes($lang,  <OCR/>, <Activity/>)
              }
            </Tab>
